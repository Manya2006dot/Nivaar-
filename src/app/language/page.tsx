...
export default function LanguageScreen() {
  ...
  return (
    <div className="flex flex-col min-h-full px-6 pb-8 justify-between">
      <div>
        <TopBar onBack={() => router.push("/")} />
        <div className="text-[26px] mb-1 mt-1" style={{ fontFamily: "var(--font-baloo)", fontWeight: 800, color: T.ink }}>Welcome to Nivaar 👋</div>
