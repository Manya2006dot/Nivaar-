      ...
      <body style={{ fontFamily: "var(--font-jakarta)" }}>
        <LanguageProvider>
          <div style={{ background: "#DDE3DC", minHeight: "100vh" }} className="flex items-center justify-center py-6 px-3">
            <div className="w-full max-w-[430px] flex flex-col overflow-hidden app-frame-height" style={{ background: "#FFFBF3", maxHeight: 900, borderRadius: 40, boxShadow: "0 30px 60px -20px rgba(15,36,25,0.35)" }}>
              {children}
            </div>
          </div>
        </LanguageProvider>
